...
import CustomJerseyForm from './CustomJerseyForm';
  ...
  return (
    <>
      <SEOHead
        ...
        description="Le Maillot MAGAPE est bien plus qu'un vêtement : c'est une bannière d'unité pour dire au monde : 'Nous sommes une seule famille en Christ'. Design aux couleurs MAGAPE, symbole fédérateur pour vos rassemblements."
        keywords={[
          "maillot MAGAPE",
          "vêtements chrétiens",
          "uniformes église",
          "maillot sport chrétien",
          "vêtements communauté chrétienne",
          "symboles chrétiens",
          "unité chrétienne",
          "équipe chrétienne"
        ]}
        image="/image-1.png"
        url="https://magape.org/#products"
        type="product"
            ...
            <CustomJerseyForm>
              <button className="group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-[#fe1556] hover:bg-[#e6134d] text-white rounded-full font-semibold text-sm sm:text-base transition-all duration-300 hover:shadow-lg hover:shadow-[#fe1556]/25">
                <span className="flex items-center justify-center">
                  Un maillot aux couleurs de mon assemblée
